...
<body>
	...
	<p>
		<button type="button" onclick="refresh(5)">5개가져오기</button>
		<button type="button" onclick="refresh(10)">10개가져오기</button>
	</p>
	<h3>결과창</h3>
	<%--
		ajax 로 가져온 데이터를 이용해서 출력할때 key 라는 이름에 설정된 데이터는
			...
			req.onreadystatechange= function() {
				if(this.readyState == 4) {
					...
					for(var i=0; i<obj.length; i++){
						...
						if(obj[i].recommend) {
							html += "<small style=\"color: red\">추천상품</small>";
						}
						html += "</p>";
					}
